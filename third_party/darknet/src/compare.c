...
void train_compare(char *cfgfile, char *weightfile)
{
    ...
    int imgs = 1024;
    dn_list *plist = get_paths("data/compare.train.list");
...
void validate_compare(char *filename, char *weightfile)
{
    ...
    dn_list *plist = get_paths("data/compare.val.list");
    //dn_list *plist = get_paths("data/compare.val.old");
    char **paths = (char **)list_to_array(plist);
    int N = plist->size/2;
    free_list(plist);
...
void SortMaster3000(char *filename, char *weightfile)
{
    ...
    dn_list *plist = get_paths("data/compare.sort.list");
    //dn_list *plist = get_paths("data/compare.val.old");
    char **paths = (char **)list_to_array(plist);
    int N = plist->size;
    free_list(plist);
...
void BattleRoyaleWithCheese(char *filename, char *weightfile)
{
    ...
    dn_list *plist = get_paths("data/compare.sort.list");
    //dn_list *plist = get_paths("data/compare.small.list");
    //dn_list *plist = get_paths("data/compare.cat.list");
    //dn_list *plist = get_paths("data/compare.val.old");
    char **paths = (char **)list_to_array(plist);
    int N = plist->size;
    int total = N;
